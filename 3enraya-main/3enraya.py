...
def esGanador(tablero, jugador):
    ...
    return ((b['1'] == b['2'] == b['3'] == b['4'] == p) or  # Horizontal 1
            (b['5'] == b['6'] == b['7'] == b['8'] == p) or  # Horizontal 2
            (b['9'] == b['10'] == b['11'] == b['12'] == p) or  # Horizontal 3
            (b['13'] == b['14'] == b['15'] == b['16'] == p) or # Horizontal 4
            (b['1'] == b['5'] == b['9'] == b['13'] == p) or  # Vertical 1
            (b['2'] == b['6'] == b['10'] == b['14'] == p) or  # Vertical 2
            (b['3'] == b['7'] == b['11'] == b['15'] == p) or  # Vertical 3
            (b['4'] == b['8'] == b['12'] == b['16'] == p) or  # Vertical 4  
            (b['1'] == b['6'] == b['11'] == b['16'] == p) or  # Diagonal 1
            ((b['4'] == b['7'] == b['10'] == b['13'] == p))  # Diagonal 2
